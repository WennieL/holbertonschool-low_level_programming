...
### [0. Tread lightly, she is near](https://github.com/WennieL/holbertonschool-low_level_programming/blob/main/file_io/0-read_textfile.c)
...
- where filename is the name of the file and text_content is the NULL terminated string 
